...
export const SignIn = () => {
    ...
    return (
        <div className="mx-auto md:mt-32 mt-20 flex flex-col max-w-md p-6 rounded-md sm:p-10 dark:bg-gray-900 dark:text-gray-100">
                    ...
                    <div>
                        <div className="flex justify-between mb-2">
                            ...
                            <a rel="noopener noreferrer" href="/#"
                               className="text-xs hover:underline dark:text-gray-400">Forgot password?</a>
                        </div>
